...
import static nb.cblink.readbook.R.string.*;;
import static nb.cblink.readbook.R.string.pref_book_firstpageoffset_id;
import static nb.cblink.readbook.R.string.pref_book_firstpageoffset_minvalue;
import static nb.cblink.readbook.R.string.pref_book_id;
